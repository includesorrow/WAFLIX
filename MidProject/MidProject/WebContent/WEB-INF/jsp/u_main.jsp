			...
			$("#searchtarget").click(function(e) {
								...
								if(${sessionScope.uid == null}){
									...
									$.ajax({
										...
										var tag_len = data.tag_list.length;
										...
										for ( var i in data.comment_list) {
												$('#comment').html(
												"<tr><td>"
												+ data.comment_list[i].MEMBER_NAME
												+ "("+ data.comment_list[i].MEMBER_ID
												+ ")</td><td rowspan=\"2\" style=\"border-left: 1px\">"
												+ data.comment_list[i].USEDWORDS_CONTENTS+ "</td></tr>"
												+ "<tr><td> "+ data.comment_list[i].USEDWORDS_TIMES+ "</td></tr>");
										}
