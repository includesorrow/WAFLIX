...
public class DefaultController {
	...
	public String MainPage(Model m) {
		...
		List<List<String>> list_popular = mdao.make_movie_list(title_list_popular);
		List<List<String>> list_boxOffice = mdao.make_movie_list(title_list_boxOffice);
		List<List<String>> list_lastviewed = mdao.make_movie_list(title_list_lastviewed);
		List<List<String>> list_saved = mdao.make_movie_list(title_list_saved);
		List<List<String>> list_pay = mdao.make_movie_list(title_list_pay);
		List<List<String>> list_free = mdao.make_movie_list(title_list_free);
		List<List<String>> list_similar_mylike = mdao.make_movie_list(title_list_similar_mylike);
		List<List<String>> list_similar_tome = mdao.make_movie_list(title_list_similar_tome);
